...
const BASE_SYSTEM = `你是 OpenClaw V7 - 有记忆的 Agent。

工作循环: recall -> identify -> plan -> (load-skill) -> execute -> track -> remember
...
if (process.argv[2]) {
  ...
  console.log(`\nOpenClaw V7 - 分层记忆 Agent (${identitySystem.getName()}) - 输入 'q' 退出`);
